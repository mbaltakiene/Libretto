    ...
    public static class BookPreferenceFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener {
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (preference instanceof ListPreference) {
                ...
                // Restrict user input to values between 1 and 40
                // since the max value allowed by the Google Books API
                // is 40 for Maximum Results displayed
                int val = Integer.parseInt(stringValue);
                if ((val > 40) || (val < 1)) {
                    Toast.makeText(getActivity(), R.string.settings_results_range, Toast.LENGTH_SHORT).show();
                    return false;
                } else {
